This document will highlight steps taken to complete the first project associated with the Exploratory Data Analysis MOOC hosted by Johns Hopkins University. The assignment specifications are found in the original README posted in the repo I forked for this assignment (please see below). The data source is linked within that document. Data documentation is found here: http://archive.ics.uci.edu/ml/index.php.
